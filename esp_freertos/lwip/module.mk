...
INCDIR  += $(MODULE_PATH)/include $(MODULE_PATH)/include/lwip/arch
INCDIR  += $(MODULE_PATH)/include $(MODULE_PATH)/include/lwip/ipv4
INCDIR  += $(MODULE_PATH)/include $(MODULE_PATH)/include/lwip/ipv6
INCDIR  += $(MODULE_PATH)/include $(MODULE_PATH)/include/lwip
INCDIR  += $(MODULE_PATH)/include $(MODULE_PATH)/include/netif
INCDIR  += $(MODULE_PATH)/include $(MODULE_PATH)/include/posix
